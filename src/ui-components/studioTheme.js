...
export default createTheme({
  ...
  tokens: {
    components: {
      ...
      button: {
        ...
        link: {
          ...
          paddingBlockEnd: { value: "{space.xxxs.value}" },
          paddingInlineStart: { value: "{space.xxxs.value}" },
          paddingInlineEnd: { value: "{space.xxxs.value}" },
          _hover: {
            borderColor: { value: "transparent" },
            backgroundColor: { value: "transparent" },
            color: { value: "{colors.font.primary.value}" },
      ...
      rating: {
        ...
        filled: { color: { value: "{colors.brand.primary.80.value}" } },
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(223, 100%, 75%)" },
          20: { value: "hsl(223, 100%, 70%)" },
          40: { value: "hsl(223, 100%, 60%)" },
          60: { value: "hsl(223, 100%, 50%)" },
          80: { value: "hsl(223, 100%, 40%)" },
          90: { value: "hsl(223, 100%, 30%)" },
          100: { value: "hsl(223, 100%, 25%)" },
        },
        secondary: {
          10: { value: "hsl(218, 5%, 55%)" },
          20: { value: "hsl(217, 5%, 46%)" },
          40: { value: "hsl(219, 12%, 29%)" },
          60: { value: "hsl(218, 39%, 11%)" },
          80: { value: "hsl(219, 38%, 9%)" },
          90: { value: "hsl(217, 39%, 6%)" },
          100: { value: "hsl(218, 38%, 6%)" },
        },
      },
      font: {
      ...
      border: {
        ...
        focus: { value: "{colors.brand.secondary.40.value}" },
